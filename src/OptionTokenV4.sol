...
contract OptionTokenV4 is ERC20, AccessControl {
    ...
    function getTimeWeightedAveragePrice( /// @audit This is bad for sure
        uint256 _amount
    ) public view returns (uint256) {
    ...
    function _exerciseLp(
        ...
        (, , lpAmount) = IRouter(router).addLiquidity(
            ...
            _amount,
            paymentAmountToAddLiquidity,
            1, /// @audit This is poorly checked, and can cause losses
            1,
            address(this),
            block.timestamp
        );
    ...
    function _transferRewardToGauge() internal {
        ...
        if(rewardsAddress != address(0)) {
            ...
            /// @audit Can this still round to 0 and cause DOS?
